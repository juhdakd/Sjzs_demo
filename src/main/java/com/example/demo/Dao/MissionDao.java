...
public interface MissionDao {
    @Insert("insert into mission(thread_id, text) values(#{thread_id}, #{mainMission})")
    void input(String thread_id, String mainMission);
    ...
    @Update("update mission set text=#{text} where thread_id=#{thread_id}")
